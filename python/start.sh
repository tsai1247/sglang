...
NANO_PEARL_GAMMA_MIN=1 \
NANO_PEARL_GAMMA_MAX=4 \
NANO_PEARL_SGLANG_WAIT_TIMEOUT_LIMIT=0 \
NANO_PEARL_SGLANG_KICK_ON_TIMEOUT=1 \
NANO_PEARL_TEMPERATURE_SCALE=0.5 \
NANO_PEARL_SGLANG_PREFETCH_STEPS=1 \
NANO_PEARL_STREAM_BARRIER_INTERVAL=1 \
NANO_PEARL_SGLANG_PREFETCH_FLUSH_STEPS=1 \
NANO_PEARL_SGLANG_STREAM_WAIT_TIMEOUT_S=60 \
NANO_PEARL_SGLANG_WAIT_TIMEOUT_S=60 \
NANO_PEARL_SGLANG_USE_STREAM_STEPS=1 \
