...
NANO_PEARL_GAMMA=8 \
NANO_PEARL_ACCEPT_RATE_LOG_INTERVAL=50 \
NANO_PEARL_ADAPT_GAMMA=1 \
NANO_PEARL_ACCEPT_RATE_LOW=0.2 \
NANO_PEARL_ACCEPT_RATE_HIGH=0.5 \
NANO_PEARL_GAMMA_MIN=2 \
NANO_PEARL_GAMMA_MAX=8 \
NANO_PEARL_SGLANG_WAIT_TIMEOUT_LIMIT=3 \
NANO_PEARL_FORCE_TEMPERATURE=0 \
